...
im_train_list = glob.glob(
    '/Users/aihemaitiabulipizi/Documents/ahmatjan/cv-aihe/CV-personal/dataset/cifar10/TRAIN/*/*.png'
)
im_test_list = glob.glob(
    '/Users/aihemaitiabulipizi/Documents/ahmatjan/cv-aihe/CV-personal/dataset/cifar10/TEST/*/*.png'
)
